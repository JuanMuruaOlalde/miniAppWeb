function PonerElContenidoDeGatos() {
    ...
    contenedorSecundario.innerHTML = '<p><a href="https://commons.wikimedia.org/wiki/File:Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg#/media/File:Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg">'
...
function PonerElContenidoDeJirafas() {
    const contenedorPrincipal = document.querySelector("#contenedor_principal");
    contenedorPrincipal.innerHTML = '<h2>El contenido de jirafas</h2>'
